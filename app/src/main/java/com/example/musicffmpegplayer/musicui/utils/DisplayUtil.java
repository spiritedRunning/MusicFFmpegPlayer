package com.example.musicffmpegplayer.musicui.utils;
...
public class DisplayUtil {
    ...
    public void try2UpdateMusicPicBackground(final Activity activity, final BackgourndAnimationRelativeLayout mRootLayout, final int musicPicRes) {

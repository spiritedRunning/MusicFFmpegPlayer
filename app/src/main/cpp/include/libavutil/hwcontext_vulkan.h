...
typedef struct AVVulkanDeviceContext {
    ...
    VkDevice act_dev;
    /**
     * DataQueue family index for graphics
    ...
    /**
     * DataQueue family index to use for transfer operations, and the amount of queues
    ...
    int nb_tx_queues;
    /**
     * DataQueue family index for compute ops, and the amount of queues enabled.
